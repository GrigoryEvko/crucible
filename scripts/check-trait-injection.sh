...
Scanned traits and their authoring sets:
  ...
  value_type_decoupled      + test/test_concept_cheat_probe.cpp
  graded_modality
...
#
# Family A keeps its original single authoring set verbatim, so this
# rewrite does not relax any trait that was already guarded.
substrate_paths='include/crucible/algebra/* include/crucible/safety/* include/crucible/permissions/* include/crucible/handles/* test/test_concept_cheat_probe.cpp'
