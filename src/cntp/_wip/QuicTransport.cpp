...
std::string_view quic_error_name(QuicError error) noexcept {
    switch (error) {
        case QuicError::InvalidSocketFd:
            return "InvalidSocketFd";
        case QuicError::InvalidStreamLimit:
            return "InvalidStreamLimit";
        case QuicError::StreamLimitExceeded:
            return "StreamLimitExceeded";
        case QuicError::UnknownStream:
            return "UnknownStream";
        case QuicError::StreamAlreadyClosed:
            return "StreamAlreadyClosed";
        case QuicError::DatagramDisabled:
            return "DatagramDisabled";
        case QuicError::DatagramEmpty:
            return "DatagramEmpty";
        case QuicError::DatagramTooLarge:
            return "DatagramTooLarge";
        case QuicError::ZeroRttDisabled:
            return "ZeroRttDisabled";
        case QuicError::EmptyResumptionToken:
            return "EmptyResumptionToken";
        case QuicError::ResumptionTokenTooLarge:
            return "ResumptionTokenTooLarge";
        case QuicError::MigrationDisabled:
            return "MigrationDisabled";
        case QuicError::InvalidMigrationPlan:
            return "InvalidMigrationPlan";
        case QuicError::MtlsRejected:
            return "MtlsRejected";
        case QuicError::BackendUnavailable:
            return "BackendUnavailable";
        default:
            return "<unknown QuicError>";
    }
}
...
std::string_view quic_feature_name(QuicFeature feature) noexcept {
    switch (feature) {
        case QuicFeature::Datagrams:
            return "Datagrams";
        case QuicFeature::ZeroRtt:
            return "ZeroRtt";
        case QuicFeature::Migration:
            return "Migration";
        case QuicFeature::KernelBackend:
            return "KernelBackend";
        case QuicFeature::UserspaceBackend:
            return "UserspaceBackend";
        default:
            return "<unknown QuicFeature>";
    }
}

std::string_view quic_stream_kind_name(QuicStreamKind kind) noexcept {
    switch (kind) {
        case QuicStreamKind::Bidirectional:
            return "Bidirectional";
        case QuicStreamKind::Unidirectional:
            return "Unidirectional";
        default:
            return "<unknown QuicStreamKind>";
    }
}
