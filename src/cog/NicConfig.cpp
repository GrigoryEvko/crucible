...
std::string_view nic_config_error_name(NicConfigError error) noexcept {
    switch (error) {
        case NicConfigError::None:
            return "None";
        case NicConfigError::ZeroCog:
            return "ZeroCog";
        case NicConfigError::NonNicCog:
            return "NonNicCog";
        case NicConfigError::InvalidRingSize:
            return "InvalidRingSize";
        case NicConfigError::InvalidQueueCount:
            return "InvalidQueueCount";
        case NicConfigError::InvalidRssTableSize:
            return "InvalidRssTableSize";
        case NicConfigError::InvalidSpeedMbps:
            return "InvalidSpeedMbps";
        case NicConfigError::InvalidSysctlBytes:
            return "InvalidSysctlBytes";
        case NicConfigError::InvalidSysctlPackets:
            return "InvalidSysctlPackets";
        case NicConfigError::InvalidBusyPollUs:
            return "InvalidBusyPollUs";
        case NicConfigError::InvalidTcpRtoMinUs:
            return "InvalidTcpRtoMinUs";
        case NicConfigError::InvalidTcpMemoryTriple:
            return "InvalidTcpMemoryTriple";
        case NicConfigError::InvalidInterfaceName:
            return "InvalidInterfaceName";
        case NicConfigError::InterfaceMismatch:
            return "InterfaceMismatch";
        case NicConfigError::PrivilegedApplyDeferred:
            return "PrivilegedApplyDeferred";
        case NicConfigError::PrivilegedBackendUnavailable:
            return "PrivilegedBackendUnavailable";
        case NicConfigError::QueryDeferred:
            return "QueryDeferred";
        default:
            return "<unknown NicConfigError>";
    }
}
