...
p4::P4ProgramSpec program_spec(bool compiler_available = false, bool allow_backend_compile = false,
...
void test_admission_and_names() {
    assert(p4::p4_error_name(p4::P4Error::CompileDeferred) == std::string_view{"CompileDeferred"});
