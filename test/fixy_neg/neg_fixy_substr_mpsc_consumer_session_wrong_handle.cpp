...
int main() {
    ...
    neg_fixy_mpsc_consumer_session_wrong_handle::Channel::ProducerHandle* producer_handle = nullptr;

    auto bad =
        fmpsc::mint_mpsc_consumer_session<neg_fixy_mpsc_consumer_session_wrong_handle::Channel>(ctx, *producer_handle);
    (void)bad;
    return 0;
}
