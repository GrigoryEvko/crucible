...
int main() {
    ...
    crucible::safety::Tagged<int, ft::source::External> external{
        42};  // FIXY-DISCIPLINE-OK: neg fixture exercises substrate Tagged<> directly to hit the V-024 wired retag() requires-clause
