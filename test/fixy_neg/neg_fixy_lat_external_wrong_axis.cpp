...
using BadPack =
    std::tuple<strict<D::Type>, strict<D::Refinement>, strict<D::Usage>, strict<D::Effect>,
               /* Security axis intentionally omitted — caller mistakenly thought
     * the Trust tag also covered Security. */
               gr::trust_external, strict<D::Protocol>, strict<D::Lifetime>, strict<D::Provenance>, gr::trust_external,
...
static_assert(sizeof(SecurityTag) > 0 && false, "FixyNotEngaged_Security: gr::trust_external engages Trust, NOT "
