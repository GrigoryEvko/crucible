// fixy_neg: gr::as_classified used in lieu of a Trust engagement.
//
// FIXY-LAT-Security: `as_classified` is a Security-axis lattice point.
...
struct TypeFixyLatClassifiedWrongAxis {};

using BadPack =
    std::tuple<strict<D::Type>, strict<D::Refinement>, strict<D::Usage>, strict<D::Effect>, gr::as_classified,
               strict<D::Protocol>, strict<D::Lifetime>, strict<D::Provenance>, gr::as_classified,
...
static_assert(sizeof(TrustTag) > 0 && false, "FixyNotEngaged_Trust: gr::as_classified engages Security, NOT Trust.");
