...
namespace probe {
using F = sfn::Fn<TypeI004, sfn::pred::True, sfn::UsageMode::Linear, eff::Row<>, sfn::SecLevel::Classified, ToyProto>;
}  // namespace probe
...
using Witness = fixy::fn<TypeI004, strict<D::Refinement>, strict<D::Usage>, strict<D::Effect>, strict<D::Security>,
                         ...
                         strict<D::Overflow>, strict<D::Mutation>, strict<D::Reentrancy>, strict<D::Size>,
