// fixy_neg: stance::RealtimeHot<int&> rejects via Type-axis gate.
//
// HS14 floor for FIXY-U-041 (RealtimeHot stance, reference angle).
// A reference Type would bind to an external lvalue at construction,
// defeating the wrapper's value-semantic ownership contract.
// Distinct rejection class from the void fixture.
//
