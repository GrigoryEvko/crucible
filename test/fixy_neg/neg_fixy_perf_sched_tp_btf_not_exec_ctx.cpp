...
//
// FIXY-U-121b negative fixture #2 (HS14 ≥2 floor, mint #4 of 8):
// `mint_sched_tp_btf` IsExecCtx-half failure routed through the
...
// "CtxFitsSchedTpBtfMint" / "IsExecCtx" / "NotAnExecCtx".

#include <crucible/fixy/Perf.h>

namespace test_fixy_perf_sched_tp_btf_not_exec_ctx {
...
int main() {
    auto hub = crucible::fixy::perf::mint_sched_tp_btf(test_fixy_perf_sched_tp_btf_not_exec_ctx::NotAnExecCtx{},
