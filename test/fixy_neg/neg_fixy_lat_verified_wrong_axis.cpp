...
using BadPack =
    std::tuple<strict<D::Type>, strict<D::Refinement>, strict<D::Usage>, strict<D::Effect>, gr::trust_verified,
...
static_assert(sizeof(SecurityTag) > 0 && false, "FixyNotEngaged_Security: gr::trust_verified engages Trust, "
                                                "NOT Security.");
