...
namespace probe {
using F = sfn::Fn<TypeL002, sfn::pred::True, sfn::UsageMode::Borrow>;
}  // namespace probe
...
using Witness =
    fixy::fn<TypeL002, strict<D::Refinement>, gr::borrow, strict<D::Effect>, strict<D::Security>, strict<D::Protocol>,
