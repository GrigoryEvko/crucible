// fixy_neg: gr::as_public used in lieu of a Trust engagement.
//
// FIXY-LAT-Security: `as_public` is a Security-axis lattice point.
...
struct TypeFixyLatPublicWrongAxis {};

// Engage Security with as_public (correct), Trust with as_public
// (wrong axis).  Trust ends up unengaged.
using BadPack =
    std::tuple<strict<D::Type>, strict<D::Refinement>, strict<D::Usage>, strict<D::Effect>, gr::as_public,
               strict<D::Protocol>, strict<D::Lifetime>, strict<D::Provenance>, gr::as_public,
...
static_assert(sizeof(TrustTag) > 0 && false, "FixyNotEngaged_Trust: gr::as_public engages Security, NOT Trust.");
