...
int main() {
    int not_a_ctx = 0;
    neg_fixy_sg_consumer_session_non_ctx::Grid::template ConsumerHandle<0>* handle = nullptr;

    auto bad = fsg::mint_consumer_session<neg_fixy_sg_consumer_session_non_ctx::Grid, 0>(not_a_ctx, *handle);
    (void)bad;
    return 0;
}
