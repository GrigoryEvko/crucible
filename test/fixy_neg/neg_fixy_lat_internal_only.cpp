// fixy_neg: gr::as_internal is the only engagement — 19 axes unengaged.
//
...
struct TypeFixyLatInternalOnly {};

static_assert(!crucible::fixy::IsAccepted<TypeFixyLatInternalOnly, gr::as_internal>,
              "A single Security lattice tag must reject — 19 axes unengaged.");

static_assert(crucible::fixy::first_missing_axis_v<gr::as_internal> == D::Type,
...
static_assert(sizeof(TypeAxisTag) > 0 && false, "FixyNotEngaged_Type: a single gr::as_internal engages only "
