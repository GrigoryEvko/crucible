...
namespace probe {
using F = sfn::Fn<TypeP002, sfn::pred::True, sfn::UsageMode::Ghost>;
}  // namespace probe

namespace crucible::safety::fn::collision {
template <>
struct marks_runtime_ghost_use<probe::F> : std::true_type {};
}  // namespace crucible::safety::fn::collision

using Witness =
    fixy::fn<TypeP002, strict<D::Refinement>, gr::ghost, strict<D::Effect>, strict<D::Security>, strict<D::Protocol>,
