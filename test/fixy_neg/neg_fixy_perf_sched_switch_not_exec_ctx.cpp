...
//
// FIXY-U-121b negative fixture #2 (HS14 ≥2 floor, mint #3 of 8):
// `mint_sched_switch` IsExecCtx-half failure routed through the
...
// "CtxFitsSchedSwitchMint" / "IsExecCtx" / "NotAnExecCtx".

#include <crucible/fixy/Perf.h>

namespace test_fixy_perf_sched_switch_not_exec_ctx {
...
int main() {
    auto hub = crucible::fixy::perf::mint_sched_switch(test_fixy_perf_sched_switch_not_exec_ctx::NotAnExecCtx{},
