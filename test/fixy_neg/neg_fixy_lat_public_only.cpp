// fixy_neg: gr::as_public is the only engagement — 19 axes unengaged.
//
...
struct TypeFixyLatPublicOnly {};

static_assert(!crucible::fixy::IsAccepted<TypeFixyLatPublicOnly, gr::as_public>,
              "A single Security lattice tag must reject — 19 axes unengaged.");

static_assert(crucible::fixy::first_missing_axis_v<gr::as_public> == D::Type,
...
static_assert(sizeof(TypeAxisTag) > 0 && false, "FixyNotEngaged_Type: a single gr::as_public engages only "
