// fixy_neg: gr::trust_tested used in lieu of a Security engagement.
//
// FIXY-LAT-Trust: `trust_tested` is a Trust-axis lattice point.
...
struct TypeFixyLatTestedWrongAxis {};

using BadPack =
    std::tuple<strict<D::Type>, strict<D::Refinement>, strict<D::Usage>, strict<D::Effect>, gr::trust_tested,
...
static_assert(sizeof(SecurityTag) > 0 && false, "FixyNotEngaged_Security: gr::trust_tested engages Trust, "
                                                "NOT Security.");
