...
//
// FIXY-V-215 HS14 fixture #2 of 2 for fixy::pipe::mint_pool_submit:
...
// identically.  Routing through `fixy::pipe::mint_pool_submit` must
...
int main() {
    ...
    fpipe::mint_pool_submit(fg, pool, safe_job);
