...
int main() {
    ...
    auto bad = fixy::mint_fn<
        ...
        strict<D::Synchronization>, strict<D::Regime>, strict<D::FpMode>, strict<D::ControlFlow>, strict<D::CallShape>,
        ...
        grs::family_file_mutation /* SyscallSurface #1 */, grs::per<SI::pwrite> /* SyscallSurface #2 — duplicate */>(
        42);
    (void)bad;
    return 0;
}
