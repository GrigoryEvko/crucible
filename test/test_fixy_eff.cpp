...
// look-alike declared in the re-exporting namespace.  Every alias in the
// effect surface is materialised here so that claim is checked in one
// place.
...
static_assert(std::is_same_v<fe::row_union_t<fe::Row<fe::Effect::Alloc>, fe::Row<fe::Effect::IO>>,
...
static_assert(
    std::is_same_v<fe::Computation<fe::Row<>, EffSentinel_PayloadA>, ce::Computation<ce::Row<>, EffSentinel_PayloadA>>,
...
static_assert(fe::cap_of_v<fe::Capability<fe::Effect::Alloc, fe::Bg>> == fe::Effect::Alloc);
...
// A row lower in the chain satisfies every row above it, and not the
// other way round.
static_assert(fe::IsAll<fe::PureRow>);
static_assert(fe::IsST<fe::PureRow>);
static_assert(fe::IsDiv<fe::PureRow>);
static_assert(!fe::IsPure<fe::DivRow>);
...
using EffSentinel_Concurrent = fe::ConcurrentRow<fe::SmBudget<128>, fe::HbmBytes<4096>>;
static_assert(std::is_same_v<EffSentinel_Concurrent, ce::ConcurrentRow<ce::SmBudget<128>, ce::HbmBytes<4096>>>);
