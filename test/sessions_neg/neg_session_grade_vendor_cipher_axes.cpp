...
using Provided = saf::CipherTier<alg::CipherTierTag::Cold, saf::Vendor<alg::VendorBackend::AMD, Kernel>>;
using Required = saf::CipherTier<alg::CipherTierTag::Hot, saf::Vendor<alg::VendorBackend::NV, Kernel>>;
