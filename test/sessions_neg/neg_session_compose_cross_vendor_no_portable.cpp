...
using NvHandle = proto::PermissionedSessionHandle<proto::Send<int, proto::End>, proto::EmptyPermSet, Wire,
                                                  proto::VendorCtx<proto::VendorBackend::NV>>;

using AmdHandle = proto::PermissionedSessionHandle<proto::Send<int, proto::End>, proto::EmptyPermSet, Wire,
