...
int main() {
    ...
    using Proto = proto::Send<proto::Transferable<BgValue, WorkItem>, proto::End>;

    eff::HotFgCtx fg;
    auto perm = mint_permission_root<WorkItem>();
    [[maybe_unused]] auto h = proto::mint_permissioned_session<Proto>(fg, FakeChannel{}, std::move(perm));
    return 0;
}
