...
using CollectiveProto = proto::Loop<proto::Send<NvTile, proto::Continue>>;

using BadMint = decltype(proto::mint_permissioned_session<CollectiveProto>(std::declval<eff::HotFgCtx const&>(),
                                                                           std::declval<Wire>()));
