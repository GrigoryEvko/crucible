...
using BadMint =
    decltype(cc::mint_substrate_session<AmdSpsc, cc::Direction::Producer, proto::VendorCtx<proto::VendorBackend::NV>>(
        std::declval<eff::HotFgCtx const&>(), std::declval<AmdProducer&>()));
