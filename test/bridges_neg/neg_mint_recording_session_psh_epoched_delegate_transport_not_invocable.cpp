...
using CarrierProto = proto::EpochedDelegate<proto::DelegatedSession<InnerProto, proto::EmptyPermSet>, proto::End,
                                            /*MinEpoch=*/7,
                                            /*MinGeneration=*/2>;
...
int main() {
    using namespace neg_mint_recording_session_psh_epoched_delegate_transport_not_invocable;
