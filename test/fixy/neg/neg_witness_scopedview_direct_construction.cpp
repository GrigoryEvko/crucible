...
//
// fixy::ScopedView<int, int> attests to a fact it cannot see.  The expression below is the
...
int main() {
    [[maybe_unused]] auto forged = fixy::ScopedView<int, int>{forge::lvalue<int const>()};
    return 0;
}
