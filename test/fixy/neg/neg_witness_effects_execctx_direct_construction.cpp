...
//
// foundation::effects::ExecCtx<foundation::effects::Bg, foundation::effects::Row<foundation::effects::Effect::Bg>> attests to a fact it cannot see.  The expression below is the
...
int main() {
    [[maybe_unused]] auto forged = foundation::effects::ExecCtx<foundation::effects::Bg, foundation::effects::Row<foundation::effects::Effect::Bg>>{};
    return 0;
}
