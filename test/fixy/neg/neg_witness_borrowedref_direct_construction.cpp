...
//
// fixy::BorrowedRef<int> attests to a fact it cannot see.  The expression below is the
...
int main() {
    [[maybe_unused]] auto forged = fixy::BorrowedRef<int>{fixy::detail::borrow_mint_t{}, forge::lvalue<int>()};
    return 0;
}
