...
//
// fixy::CpuPinned<foundation::algebra::lattices::AffinityMask::single(0), fixy::PinningPosture::PinnedExplicit, int> attests to a fact it cannot see.  The expression below is the
...
int main() {
    [[maybe_unused]] auto forged = fixy::CpuPinned<foundation::algebra::lattices::AffinityMask::single(0), fixy::PinningPosture::PinnedExplicit, int>{0};
    return 0;
}
