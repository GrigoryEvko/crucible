...
//
// fixy::session::SessionEvent attests to a fact it cannot see.  The expression below is the
...
int main() {
    [[maybe_unused]] auto forged = fixy::session::SessionEvent{fixy::session::SessionOp::Stop, fixy::session::RoleTagId{}, fixy::session::RoleTagId{}, 0, 0, 0, 200};
    return 0;
}
