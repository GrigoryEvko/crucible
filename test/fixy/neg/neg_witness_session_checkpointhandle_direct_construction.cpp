...
//
// fixy::session::CheckpointHandle<fixy::session::SessionHandle<fixy::session::End, int*>, fixy::session::End, void, fixy::session::CheckpointFrame<fixy::session::End, fixy::session::End, void>> attests to a fact it cannot see.  The expression below is the
...
int main() {
    [[maybe_unused]] auto forged = fixy::session::CheckpointHandle<fixy::session::SessionHandle<fixy::session::End, int*>, fixy::session::End, void, fixy::session::CheckpointFrame<fixy::session::End, fixy::session::End, void>>{forge::rvalue<fixy::session::SessionHandle<fixy::session::End, int*>>()};
    return 0;
}
