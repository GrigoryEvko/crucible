...
//
// foundation::permissions::detail::ForkRebuildKey attests to a fact it cannot see.  The expression below is the
...
int main() {
    [[maybe_unused]] auto forged = foundation::permissions::detail::ForkRebuildKey{};
    return 0;
}
