...
//
// fixy::OwnedMmap<int, int, int> attests to a fact it cannot see.  The expression below is the
...
int main() {
    [[maybe_unused]] auto forged = fixy::OwnedMmap<int, int, int>{static_cast<void*>(nullptr), std::size_t{0}};
    return 0;
}
