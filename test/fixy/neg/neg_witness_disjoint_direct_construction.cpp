...
//
// fixy::Disjoint<int, foundation::brand::DefaultBrand, fixy::Unsplit, 2> attests to a fact it cannot see.  The expression below is the
...
int main() {
    [[maybe_unused]] auto forged = fixy::Disjoint<int, foundation::brand::DefaultBrand, fixy::Unsplit, 2>{fixy::detail::split_mint_t{}};
    return 0;
}
