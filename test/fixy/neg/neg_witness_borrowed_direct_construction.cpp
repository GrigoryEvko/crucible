...
//
// fixy::Borrowed<int, int> attests to a fact it cannot see.  The expression below is the
...
int main() {
    [[maybe_unused]] auto forged = fixy::Borrowed<int, int>{fixy::detail::borrow_mint_t{}, std::span<int>{}};
    return 0;
}
