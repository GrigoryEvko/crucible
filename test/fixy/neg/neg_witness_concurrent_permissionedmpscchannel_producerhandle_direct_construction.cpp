...
//
// fixy::concurrent::PermissionedMpscChannel<int, 8>::ProducerHandle attests to a fact it cannot see.  The expression below is the
...
int main() {
    [[maybe_unused]] auto forged = fixy::concurrent::PermissionedMpscChannel<int, 8>::ProducerHandle{forge::lvalue<fixy::concurrent::PermissionedMpscChannel<int, 8>>(), forge::rvalue<foundation::permissions::SharedPermissionGuard<fixy::concurrent::mpsc_tag::Producer<void>>>()};
    return 0;
}
