...
//
// fixy::time::ClockReader<foundation::algebra::lattices::ClockSource::Monotonic> attests to a fact it cannot see.  The expression below is the
...
int main() {
    [[maybe_unused]] auto forged = fixy::time::ClockReader<foundation::algebra::lattices::ClockSource::Monotonic>{};
    return 0;
}
