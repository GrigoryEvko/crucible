// An empty atom pack names no mode, and there is no default: opening
// a file without saying how is refused rather than opened O_RDONLY.
...
int main() {
    ...
    [[maybe_unused]] auto r = fs::mint_file<>(ctx, sanitized("/tmp/fixy-neg-fs"));
    return 0;
}
