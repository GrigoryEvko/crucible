...
//
// fixy::Tagged<int, fixy::tags::source::External> attests to a fact it cannot see.  The expression below is the
...
int main() {
    [[maybe_unused]] auto forged = fixy::Tagged<int, fixy::tags::source::External>{42};
    return 0;
}
