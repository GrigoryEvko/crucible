...
//
// fixy::session::SessionFromMachine<int, fixy::session::End> attests to a fact it cannot see.  The expression below is the
...
int main() {
    [[maybe_unused]] auto forged = fixy::session::SessionFromMachine<int, fixy::session::End>{forge::rvalue<fixy::Machine<int>>()};
    return 0;
}
