...
//
// foundation::permissions::SharedPermissionPool<foundation::permissions::tag::HugePageTag> attests to a fact it cannot see.  The expression below is the
...
int main() {
    [[maybe_unused]] auto forged = foundation::permissions::SharedPermissionPool<foundation::permissions::tag::HugePageTag>{};
    return 0;
}
