// The warm writer opens a file, so its gate folds the stance atoms into
// CtxFitsFileMint and a context without Block is refused.
...
int main() {
    ...
    [[maybe_unused]] auto r = durable::mint_warm_writer<>(ctx, sanitized("/tmp/fixy-neg-warm"));
    return 0;
}
