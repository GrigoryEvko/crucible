...
//
// foundation::permissions::perm_mint_key attests to a fact it cannot see.  The expression below is the
...
int main() {
    [[maybe_unused]] auto forged = foundation::permissions::perm_mint_key{};
    return 0;
}
