...
//
// foundation::effects::detail::ctx_mint::bg_key attests to a fact it cannot see.  The expression below is the
...
int main() {
    [[maybe_unused]] auto forged = foundation::effects::detail::ctx_mint::bg_key{};
    return 0;
}
