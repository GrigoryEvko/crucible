...
//
// fixy::Qtt<foundation::algebra::lattices::QttGrade::One, int> attests to a fact it cannot see.  The expression below is the
...
int main() {
    [[maybe_unused]] auto forged = fixy::Qtt<foundation::algebra::lattices::QttGrade::One, int>{std::in_place, 42};
    return 0;
}
