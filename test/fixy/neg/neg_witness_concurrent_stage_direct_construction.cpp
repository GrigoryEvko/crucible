...
//
// fixy::concurrent::Stage<&fixy::concurrent::detail::stage_self_test::stage_pass_through, fixy::HotFgCtx> attests to a fact it cannot see.  The expression below is the
...
int main() {
    [[maybe_unused]] auto forged = fixy::concurrent::Stage<&fixy::concurrent::detail::stage_self_test::stage_pass_through, fixy::HotFgCtx>{forge::lvalue<fixy::HotFgCtx>(), forge::rvalue<fixy::concurrent::detail::stage_self_test::FakeConsumer<int>>(), forge::rvalue<fixy::concurrent::detail::stage_self_test::FakeProducer<int>>()};
    return 0;
}
