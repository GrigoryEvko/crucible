...
//
// fixy::SharedRead<int, foundation::permissions::tag::HugePageTag> attests to a fact it cannot see.  The expression below is the
...
int main() {
    [[maybe_unused]] auto forged = fixy::SharedRead<int, foundation::permissions::tag::HugePageTag>{fixy::detail::shared_read_mint_t{}, std::span<int const>{}};
    return 0;
}
