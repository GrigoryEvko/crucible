...
//
// fixy::concurrent::PermissionedMpscChannel<int, 8>::ConsumerHandle attests to a fact it cannot see.  The expression below is the
...
int main() {
    [[maybe_unused]] auto forged = fixy::concurrent::PermissionedMpscChannel<int, 8>::ConsumerHandle{forge::lvalue<fixy::concurrent::PermissionedMpscChannel<int, 8>>(), forge::rvalue<foundation::permissions::Permission<fixy::concurrent::mpsc_tag::Consumer<void>>>()};
    return 0;
}
