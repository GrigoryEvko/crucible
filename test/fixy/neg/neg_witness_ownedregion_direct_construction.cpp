...
//
// fixy::OwnedRegion<int, foundation::permissions::tag::HugePageTag> attests to a fact it cannot see.  The expression below is the
...
int main() {
    [[maybe_unused]] auto forged = fixy::OwnedRegion<int, foundation::permissions::tag::HugePageTag>{static_cast<int*>(nullptr), std::size_t{0}, forge::rvalue<foundation::permissions::Permission<foundation::permissions::tag::HugePageTag>>()};
    return 0;
}
