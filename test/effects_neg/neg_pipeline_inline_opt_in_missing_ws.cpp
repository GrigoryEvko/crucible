...
using StageT = ::crucible::concurrent::Stage<&body, ::crucible::effects::HotFgCtx>;
...
template <>
struct stage_inline_safe<::neg_pipeline_inline_opt_in_missing_ws::StageT> : std::true_type {};

}  // namespace crucible::concurrent

int main() {
    using BadPipeline = ::crucible::concurrent::Pipeline<::neg_pipeline_inline_opt_in_missing_ws::StageT>;
