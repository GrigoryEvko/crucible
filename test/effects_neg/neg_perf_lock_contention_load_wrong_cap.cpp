...
//
// GAPS-004d-AUDIT (#1280): LockContention::load() takes a `effects::Init`
// capability tag by value as its sole parameter.  Same gate as
// SenseHub/SchedSwitch/PmuSample::load — Bg / Init / Test are distinct
// 1-byte structs with no implicit conversion between them, so a
