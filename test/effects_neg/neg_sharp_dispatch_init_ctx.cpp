...
int main() {
    ...
    auto plan =
        shp::mint_sharp_fabric_plan(eff::ColdInitCtx{}, sw, caps, *shp::admit_sharp_participant_count(8), true, true);
    ...
    auto result = reducer.allreduce_via_sharp(eff::ColdInitCtx{}, input, output, recipe,
