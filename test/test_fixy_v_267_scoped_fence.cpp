...
static_assert(sf::wrapper_dimension_v<sf::ScopedFence<Ms_t::Cta, int>> == sf::DimensionAxis::MemoryScope);
static_assert(sf::wrapper_tier_v<sf::ScopedFence<Ms_t::Cta, int>> == sf::TierKind::Lattice,
              "MemoryScope is a Tier-L Lattice axis, the partial-order sibling of the "
              "SimdIsa axis.");
static_assert(sf::wrapper_modality_v<sf::ScopedFence<Ms_t::Cta, int>> == ::crucible::algebra::ModalityKind::Absolute);
static_assert(sf::verify_quadruple<sf::ScopedFence<Ms_t::Gpu, int>>(),
              "ScopedFence<> must satisfy the (lattice, modality, tier, axis) quadruple.");
...
static_assert(dg::row_hash_contribution_v<sf::ScopedFence<Ms_t::Cta, int>> != dg::row_hash_contribution_v<int>,
...
static_assert(dg::row_hash_contribution_v<sf::SimdWidthPinned<Si_t::Avx2, sf::ScopedFence<Ms_t::Cta, int>>>
