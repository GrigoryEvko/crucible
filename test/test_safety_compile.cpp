// An assertion embedded in a header is compiled only where some
// translation unit includes that header.  A header reached solely
// through an umbrella is compiled under whatever flags the umbrella's
// consumers happen to use, which is not the same thing as being
// compiled under the test flags.  This file includes every header in
// the tree for that reason, and nothing else.  Shadowing, a switch
// without a default, a name that renders differently in another
// context: each surfaces here rather than inside an unrelated change.
//
// When a header ships, add its include below.  The include is the
// whole of what is needed.
//
// Several of these headers have dedicated tests of their own, and this
...
// The exact cardinality is pinned next to the enum that declares it,
// so that adding an axis reds one place.  This witness is the floor
// half of that pair, so that removing one reds here as well.
static_assert(cs::DIMENSION_AXIS_COUNT >= 22, "floor: DimensionAxis cardinality regressed below 22 — an "
                                              "enumerator was removed without updating both the ceiling pin "
                                              "beside the enum AND this floor witness.");

[[nodiscard]] consteval bool every_tier_kind_has_name() noexcept {
    static constexpr auto enumerators = std::define_static_array(std::meta::enumerators_of(^^cs::TierKind));
...
[[nodiscard]] consteval bool every_dimension_axis_has_name() noexcept {
    static constexpr auto enumerators = std::define_static_array(std::meta::enumerators_of(^^cs::DimensionAxis));
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wshadow"
    template for (constexpr auto en : enumerators) {
...
#pragma GCC diagnostic ignored "-Wshadow"
    template for (constexpr auto en : enumerators) {
        if (cs::tier_kind_name(cs::tier_of_axis([:en:])) == std::string_view{"<unknown TierKind>"}) {
            return false;
        }
    }
#pragma GCC diagnostic pop
...
static_assert(count_dims_in_tier(cs::TierKind::Semiring) == 26);
static_assert(count_dims_in_tier(cs::TierKind::Lattice) == 3);
...
using CustomFn =
    fn::Fn<float, fn::pred::True, fn::UsageMode::Affine, crucible::effects::Row<>, fn::SecLevel::Public,
           fn::proto::None, fn::lifetime::Static, fn::source::FromUser, fn::trust::Tested, fn::ReprKind::C,
           fn::cost::Constant, fn::precision::F32, fn::space::Zero, fn::OverflowMode::Saturate,
           fn::MutationMode::Mutable, fn::ReentrancyMode::Reentrant, fn::size_pol::Unstated, 3, fn::stale::Fresh>;
...
static_assert(sizeof(fn::Fn<int, fn::pred::True, fn::UsageMode::Affine, crucible::effects::Row<>, fn::SecLevel::Public>)
              == sizeof(int));
...
// One probe per header.  A probe with an empty body is empty on
// purpose: reaching the call at all means the include was processed
// under the test target's flags and nothing in it fired.  The rest
// call a runtime check the header ships with.

void test_alloc_class_compile() { ::crucible::safety::detail::alloc_class_self_test::runtime_smoke_test(); }
void test_bits_compile() { ::crucible::safety::detail::bits_self_test::runtime_smoke_test(); }
void test_borrowed_compile() { ::crucible::safety::detail::borrowed_self_test::runtime_smoke_test(); }
void test_is_bits_compile() { ::crucible::safety::extract::detail::is_bits_self_test::runtime_smoke_test(); }
void test_is_borrowed_compile() { ::crucible::safety::extract::detail::is_borrowed_self_test::runtime_smoke_test(); }
void test_is_borrowed_ref_compile() {
    ::crucible::safety::extract::detail::is_borrowed_ref_self_test::runtime_smoke_test();
}
void test_budgeted_compile() { ::crucible::safety::detail::budgeted_self_test::runtime_smoke_test(); }
void test_checked_compile() {}
void test_cipher_tier_compile() { ::crucible::safety::detail::cipher_tier_self_test::runtime_smoke_test(); }
void test_constant_time_compile() {}
void test_witness_compile() { ::crucible::safety::detail::witness_self_test::runtime_smoke_test(); }

void test_consistency_compile() { ::crucible::safety::detail::consistency_self_test::runtime_smoke_test(); }
void test_crash_compile() { ::crucible::safety::detail::crash_self_test::runtime_smoke_test(); }
void test_det_safe_compile() { ::crucible::safety::detail::det_safe_self_test::runtime_smoke_test(); }
void test_dimension_traits_compile() {}
void test_epoch_versioned_compile() { ::crucible::safety::detail::epoch_versioned_self_test::runtime_smoke_test(); }
void test_fixed_array_compile() { ::crucible::safety::detail::fixed_array_self_test::runtime_smoke_test(); }
void test_fn_compile() {}
void test_numa_placement_compile() { ::crucible::safety::detail::numa_placement_self_test::runtime_smoke_test(); }
void test_recipe_spec_compile() { ::crucible::safety::detail::recipe_spec_self_test::runtime_smoke_test(); }
void test_hot_path_compile() { ::crucible::safety::detail::hot_path_self_test::runtime_smoke_test(); }
void test_linear_compile() {}
void test_machine_compile() {}
void test_mem_order_compile() { ::crucible::safety::detail::mem_order_self_test::runtime_smoke_test(); }
void test_mutation_compile() {}
void test_not_inherited_compile() {}
void test_numerical_tier_compile() { ::crucible::safety::detail::numerical_tier_self_test::runtime_smoke_test(); }
void test_opaque_lifetime_compile() { ::crucible::safety::detail::opaque_lifetime_self_test::runtime_smoke_test(); }
void test_owned_region_compile() {}
void test_pinned_compile() {}
void test_progress_compile() { ::crucible::safety::detail::progress_self_test::runtime_smoke_test(); }
void test_reflected_compile() { ::crucible::safety::reflected::detail::reflected_self_test::runtime_smoke_test(); }
void test_refined_compile() {}
void test_refined_algebra_compile() { ::crucible::safety::detail::refined_algebra_self_test::runtime_smoke_test(); }
void test_residency_heat_compile() { ::crucible::safety::detail::residency_heat_self_test::runtime_smoke_test(); }
void test_saturated_compile() { ::crucible::safety::detail::saturated_self_test::runtime_smoke_test(); }
void test_safety_umbrella_compile() {}
void test_vendor_compile() { ::crucible::safety::detail::vendor_self_test::runtime_smoke_test(); }
void test_scoped_view_compile() {}
void test_sealed_refined_compile() {}
void test_secret_compile() {}
void test_simd_compile() {}
void test_stale_compile() { ::crucible::safety::detail::stale_self_test::runtime_smoke_test(); }
void test_tagged_compile() {}
void test_time_ordered_compile() { ::crucible::safety::detail::time_ordered_self_test::runtime_smoke_test(); }
void test_wait_compile() { ::crucible::safety::detail::wait_self_test::runtime_smoke_test(); }
