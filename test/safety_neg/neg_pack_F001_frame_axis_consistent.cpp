...
using LinearA = sfn::Fn<int, sfn::pred::True, sfn::UsageMode::Linear, fx::Row<>,
                        sfn::SecLevel::Classified,  // ← Classified
                        sfn::proto::None, sfn::lifetime::In<7>, crucible::safety::source::FromInternal,
...
using PublicFn = sfn::Fn<int, sfn::pred::True, sfn::UsageMode::Linear, fx::Row<>,
                         sfn::SecLevel::Public,  // ← Public diverges from LinearA's Classified
                         sfn::proto::None,
                         sfn::lifetime::In<13>,  // different region — avoid L005
                         crucible::safety::source::FromInternal, crucible::safety::trust::Verified,
                         ...
                         sfn::size_pol::Unstated, 1u, sfn::stale::Fresh>;
