...
using Bad = fn::Fn<int, fn::pred::True, fn::UsageMode::Linear, crucible::effects::Row<>, fn::SecLevel::Public,
                   fn::proto::None, fn::lifetime::Static, fn::source::FromInternal, fn::trust::Verified,
                   fn::ReprKind::Opaque, fn::cost::Unstated, fn::precision::Exact, fn::space::Zero,
                   fn::OverflowMode::Trap, fn::MutationMode::Immutable, fn::ReentrancyMode::NonReentrant,
                   fn::size_pol::Unstated, 1, fn::stale::Stale<5>>;
}  // namespace neg_collision_s010
