...
int main() {
    using V = crucible::safety::extract::producer_endpoint_region_value_t<&::neg_witness_two_ints>;
    V const v{};
    (void)v;
    return 0;
}
