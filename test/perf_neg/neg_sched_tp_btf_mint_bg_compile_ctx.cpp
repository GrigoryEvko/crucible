...
//
// mint_sched_tp_btf rejects BgCompileCtx.  That context holds the
...
int main() {
    auto hub = crucible::perf::mint_sched_tp_btf(crucible::effects::BgCompileCtx{}, crucible::effects::testing::init());
    (void)hub;
    return 0;
}
