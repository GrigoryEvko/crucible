...
//
// mint_pmu_sample rejects BgCompileCtx.  That context holds the
...
int main() {
    auto hub = crucible::perf::mint_pmu_sample(crucible::effects::BgCompileCtx{}, crucible::effects::testing::init());
    (void)hub;
    return 0;
}
