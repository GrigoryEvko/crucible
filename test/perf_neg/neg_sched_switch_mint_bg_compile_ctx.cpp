...
//
// mint_sched_switch rejects BgCompileCtx.  That context holds the
...
int main() {
    auto hub = crucible::perf::mint_sched_switch(crucible::effects::BgCompileCtx{}, crucible::effects::testing::init());
    (void)hub;
    return 0;
}
