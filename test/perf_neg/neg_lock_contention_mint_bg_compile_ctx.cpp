...
//
// mint_lock_contention rejects BgCompileCtx.  That context holds the
...
int main() {
    auto hub =
        crucible::perf::mint_lock_contention(crucible::effects::BgCompileCtx{}, crucible::effects::testing::init());
    (void)hub;
    return 0;
}
