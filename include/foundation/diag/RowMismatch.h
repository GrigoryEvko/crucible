...
template <typename T>
inline constexpr std::string_view type_name = ::foundation::reflect::stable_name_of<T>;
...
// Without inline, two translation units that both include this header
// and link into one program define each reference twice.
