...
#define __CRUCIBLE_CNTP_DATAPLANE_BPF_NET_COMMON_H
...
enum crucible_net_event_kind {
    ...
    CRUCIBLE_NET_EVENT_ACK_CLOCK = 6,
    CRUCIBLE_NET_EVENT_BBR_MODEL = 7,
    CRUCIBLE_NET_EVENT_FQ_BUDGET = 8,
    CRUCIBLE_NET_EVENT_LLDP_RX = 9,
    CRUCIBLE_NET_EVENT_GOSSIP_FANOUT = 10,
};
