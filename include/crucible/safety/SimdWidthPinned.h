...
static_assert(!can_relax<Avx2Int, SimdIsa_v::Neon>, "relax<Neon> on a SimdWidthPinned<Avx2> wrapper MUST be REJECTED — "
...
static_assert(runs_on_avx2_host<Avx512BwInt>, "An AVX512BW kernel MUST pass an AVX2-host gate (Avx2 ⊑ Avx512Bw).");
static_assert(!runs_on_avx2_host<Sse2Int>, "An SSE2-only kernel MUST be REJECTED at an AVX2-host gate — it does "
                                           "NOT subsume the AVX2 requirement.");
static_assert(!runs_on_avx2_host<NeonInt>, "An ARM/NEON kernel MUST be REJECTED at an x86 AVX2-host gate "
