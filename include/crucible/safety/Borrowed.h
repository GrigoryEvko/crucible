...
static_assert(!can_default_construct<BorrowedRef<int>>, "BorrowedRef<T> default ctor MUST be deleted — null sentinel "
...
static_assert(!can_assign<B_A, B_B>, "Borrowed<T, OwnerA> = Borrowed<T, OwnerB> MUST be a compile error. "
