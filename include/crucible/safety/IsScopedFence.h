...
struct is_scoped_fence_impl<::crucible::safety::ScopedFence<S, U>> : std::true_type {
    using value_type = U;
...
template <typename T>
inline constexpr bool is_scoped_fence_v = detail::is_scoped_fence_impl<std::remove_cvref_t<T>>::value;
...
using scoped_fence_value_t = typename detail::is_scoped_fence_impl<std::remove_cvref_t<T>>::value_type;
