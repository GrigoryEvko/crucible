...
template <typename T>
inline constexpr bool is_stale_v = detail::is_stale_impl<std::remove_cvref_t<T>>::value;
...
using stale_value_t = typename detail::is_stale_impl<std::remove_cvref_t<T>>::value_type;

template <typename T>
    requires is_stale_v<T>
using stale_semiring_t = typename detail::is_stale_impl<std::remove_cvref_t<T>>::semiring_type;

template <typename T>
    requires is_stale_v<T>
using stale_staleness_t = typename detail::is_stale_impl<std::remove_cvref_t<T>>::staleness_type;
...
static_assert(std::is_same_v<stale_semiring_t<S_int>, ::crucible::algebra::lattices::StalenessSemiring>);
static_assert(std::is_same_v<stale_staleness_t<S_int>, ::crucible::algebra::lattices::StalenessSemiring::element_type>);
