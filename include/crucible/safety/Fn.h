...
struct Fn {
    ...
    static_assert(ValidComposition<Fn>, "Fn<...> grade combination violates a §6.8 collision rule. "
...
static_assert(ValidComposition<Fn<int>>, "Default Fn<...> grades must satisfy the §6.8 collision catalog.");
...
static_assert(
    row_hash_contribution_v<Fn<int>>  // Security = Classified (default)
...
static_assert(
    row_hash_contribution_v<Fn<int>>  // Row = Row<> (default)
