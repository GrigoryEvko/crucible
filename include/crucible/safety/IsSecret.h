...
template <typename T>
inline constexpr bool is_secret_v = detail::is_secret_impl<std::remove_cvref_t<T>>::value;
...
using secret_value_t = typename detail::is_secret_impl<std::remove_cvref_t<T>>::value_type;
