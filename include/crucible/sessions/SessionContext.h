...
using OfferConsumer_partial =
    Offer<Recv<Transferable<int, WorkPerm>, End>, Recv<int, End>>;  // <-- plain int, not Transferable<_, CfgPerm>
...
static_assert(perm_set_equal_v<dcb::perm_set_merge_t<PermSet<WorkPerm>, PermSet<WorkPerm>>,  // idempotent
                               PermSet<WorkPerm>>);
