...
static_assert(crash_class_count == 4, "CrashClass catalog diverged from {Abort, Throw, ErrorReturn, "
...
static_assert(every_crash_class_has_name(), "crash_class_name() switch missing arm for at least one class.");
...
static_assert(every_at_crash_class_has_name(), "CrashLattice::At<C>::name() switch missing an arm.");
