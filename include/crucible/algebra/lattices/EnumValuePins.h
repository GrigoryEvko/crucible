...
static_assert(hot_path_tier_count == 3, "FIXY-FOUND-046: HotPathTier cardinality drifted from 3.");
...
static_assert(static_cast<std::uint8_t>(HotPathTier::Warm) == 1, "FIXY-FOUND-046: HotPathTier::Warm drifted.");
static_assert(static_cast<std::uint8_t>(HotPathTier::Hot) == 2, "FIXY-FOUND-046: HotPathTier::Hot drifted.");
...
static_assert(det_safe_tier_count == 7, "FIXY-FOUND-046: DetSafeTier cardinality drifted from 7.");
...
static_assert(static_cast<std::uint8_t>(DetSafeTier::Pure) == 6, "FIXY-FOUND-046: DetSafeTier::Pure drifted.");
...
static_assert(tolerance_count == 7, "FIXY-FOUND-046: Tolerance cardinality drifted from 7.");
static_assert(static_cast<std::uint8_t>(Tolerance::RELAXED) == 0, "FIXY-FOUND-046: Tolerance::RELAXED drifted.");
static_assert(static_cast<std::uint8_t>(Tolerance::ULP_INT8) == 1, "FIXY-FOUND-046: Tolerance::ULP_INT8 drifted.");
static_assert(static_cast<std::uint8_t>(Tolerance::ULP_FP8) == 2, "FIXY-FOUND-046: Tolerance::ULP_FP8 drifted.");
static_assert(static_cast<std::uint8_t>(Tolerance::ULP_FP16) == 3, "FIXY-FOUND-046: Tolerance::ULP_FP16 drifted.");
static_assert(static_cast<std::uint8_t>(Tolerance::ULP_FP32) == 4, "FIXY-FOUND-046: Tolerance::ULP_FP32 drifted.");
static_assert(static_cast<std::uint8_t>(Tolerance::ULP_FP64) == 5, "FIXY-FOUND-046: Tolerance::ULP_FP64 drifted.");
static_assert(static_cast<std::uint8_t>(Tolerance::BITEXACT) == 6, "FIXY-FOUND-046: Tolerance::BITEXACT drifted.");
...
static_assert(vendor_backend_count == 8, "FIXY-FOUND-046: VendorBackend cardinality drifted from 8.");
static_assert(static_cast<std::uint8_t>(VendorBackend::None) == 0,
              "FIXY-FOUND-046: VendorBackend::None drifted (⊥ sentinel).");
static_assert(static_cast<std::uint8_t>(VendorBackend::CPU) == 1, "FIXY-FOUND-046: VendorBackend::CPU drifted.");
static_assert(static_cast<std::uint8_t>(VendorBackend::NV) == 2, "FIXY-FOUND-046: VendorBackend::NV drifted.");
static_assert(static_cast<std::uint8_t>(VendorBackend::AMD) == 3, "FIXY-FOUND-046: VendorBackend::AMD drifted.");
static_assert(static_cast<std::uint8_t>(VendorBackend::TPU) == 4, "FIXY-FOUND-046: VendorBackend::TPU drifted.");
static_assert(static_cast<std::uint8_t>(VendorBackend::TRN) == 5, "FIXY-FOUND-046: VendorBackend::TRN drifted.");
static_assert(static_cast<std::uint8_t>(VendorBackend::CER) == 6, "FIXY-FOUND-046: VendorBackend::CER drifted.");
...
static_assert(static_cast<std::uint8_t>(HwInstruction::Scalar) == 1, "FIXY-FOUND-046: HwInstruction::Scalar drifted.");
...
static_assert(static_cast<std::uint8_t>(BarrierStrength::None) == 0, "FIXY-FOUND-046: BarrierStrength::None drifted.");
...
static_assert(memory_scope_count == 8, "FIXY-FOUND-046: MemoryScope cardinality drifted from 8.");
...
static_assert(simd_isa_count == 15, "FIXY-FOUND-046: SimdIsa cardinality drifted from 15.");
...
static_assert(static_cast<std::uint8_t>(SimdIsa::Sse3) == 0x11, "FIXY-FOUND-046: SimdIsa::Sse3 drifted from 0x11.");
static_assert(static_cast<std::uint8_t>(SimdIsa::Ssse3) == 0x12, "FIXY-FOUND-046: SimdIsa::Ssse3 drifted from 0x12.");
static_assert(static_cast<std::uint8_t>(SimdIsa::Sse41) == 0x13, "FIXY-FOUND-046: SimdIsa::Sse41 drifted from 0x13.");
static_assert(static_cast<std::uint8_t>(SimdIsa::Sse42) == 0x14, "FIXY-FOUND-046: SimdIsa::Sse42 drifted from 0x14.");
static_assert(static_cast<std::uint8_t>(SimdIsa::Avx2) == 0x15, "FIXY-FOUND-046: SimdIsa::Avx2 drifted from 0x15.");
...
static_assert(static_cast<std::uint8_t>(SimdIsa::Sve) == 0x23, "FIXY-FOUND-046: SimdIsa::Sve drifted from 0x23.");
static_assert(static_cast<std::uint8_t>(SimdIsa::Sve2) == 0x24, "FIXY-FOUND-046: SimdIsa::Sve2 drifted from 0x24.");
...
static_assert(residency_heat_tag_count == 3, "FIXY-FOUND-046: ResidencyHeatTag cardinality drifted from 3.");
...
static_assert(static_cast<std::uint8_t>(ResidencyHeatTag::Hot) == 2, "FIXY-FOUND-046: ResidencyHeatTag::Hot drifted.");
...
static_assert(cipher_tier_tag_count == 3, "FIXY-FOUND-046: CipherTierTag cardinality drifted from 3.");
static_assert(static_cast<std::uint8_t>(CipherTierTag::Cold) == 0, "FIXY-FOUND-046: CipherTierTag::Cold drifted.");
static_assert(static_cast<std::uint8_t>(CipherTierTag::Warm) == 1, "FIXY-FOUND-046: CipherTierTag::Warm drifted.");
static_assert(static_cast<std::uint8_t>(CipherTierTag::Hot) == 2, "FIXY-FOUND-046: CipherTierTag::Hot drifted.");
...
static_assert(alloc_class_tag_count == 6, "FIXY-FOUND-046: AllocClassTag cardinality drifted from 6.");
static_assert(static_cast<std::uint8_t>(AllocClassTag::HugePage) == 0,
              "FIXY-FOUND-046: AllocClassTag::HugePage drifted.");
static_assert(static_cast<std::uint8_t>(AllocClassTag::Mmap) == 1, "FIXY-FOUND-046: AllocClassTag::Mmap drifted.");
static_assert(static_cast<std::uint8_t>(AllocClassTag::Heap) == 2, "FIXY-FOUND-046: AllocClassTag::Heap drifted.");
static_assert(static_cast<std::uint8_t>(AllocClassTag::Arena) == 3, "FIXY-FOUND-046: AllocClassTag::Arena drifted.");
static_assert(static_cast<std::uint8_t>(AllocClassTag::Pool) == 4, "FIXY-FOUND-046: AllocClassTag::Pool drifted.");
static_assert(static_cast<std::uint8_t>(AllocClassTag::Stack) == 5, "FIXY-FOUND-046: AllocClassTag::Stack drifted.");
...
static_assert(wait_strategy_count == 6, "FIXY-FOUND-046: WaitStrategy cardinality drifted from 6.");
static_assert(static_cast<std::uint8_t>(WaitStrategy::Block) == 0, "FIXY-FOUND-046: WaitStrategy::Block drifted.");
static_assert(static_cast<std::uint8_t>(WaitStrategy::Park) == 1, "FIXY-FOUND-046: WaitStrategy::Park drifted.");
...
static_assert(mem_order_tag_count == 5, "FIXY-FOUND-046: MemOrderTag cardinality drifted from 5.");
static_assert(static_cast<std::uint8_t>(MemOrderTag::SeqCst) == 0, "FIXY-FOUND-046: MemOrderTag::SeqCst drifted.");
static_assert(static_cast<std::uint8_t>(MemOrderTag::AcqRel) == 1, "FIXY-FOUND-046: MemOrderTag::AcqRel drifted.");
static_assert(static_cast<std::uint8_t>(MemOrderTag::Release) == 2, "FIXY-FOUND-046: MemOrderTag::Release drifted.");
static_assert(static_cast<std::uint8_t>(MemOrderTag::Acquire) == 3, "FIXY-FOUND-046: MemOrderTag::Acquire drifted.");
static_assert(static_cast<std::uint8_t>(MemOrderTag::Relaxed) == 4, "FIXY-FOUND-046: MemOrderTag::Relaxed drifted.");
...
static_assert(progress_class_count == 4, "FIXY-FOUND-046: ProgressClass cardinality drifted from 4.");
...
static_assert(crash_class_count == 4, "FIXY-FOUND-046: CrashClass cardinality drifted from 4.");
static_assert(static_cast<std::uint8_t>(CrashClass::Abort) == 0, "FIXY-FOUND-046: CrashClass::Abort drifted.");
static_assert(static_cast<std::uint8_t>(CrashClass::Throw) == 1, "FIXY-FOUND-046: CrashClass::Throw drifted.");
static_assert(static_cast<std::uint8_t>(CrashClass::ErrorReturn) == 2,
              "FIXY-FOUND-046: CrashClass::ErrorReturn drifted.");
static_assert(static_cast<std::uint8_t>(CrashClass::NoThrow) == 3, "FIXY-FOUND-046: CrashClass::NoThrow drifted.");
...
static_assert(suspend_behavior_count == 3, "FIXY-FOUND-046: SuspendBehavior cardinality drifted from 3.");
...
static_assert(join_policy_count == 6, "FIXY-FOUND-046: JoinPolicy cardinality drifted from 6.");
static_assert(static_cast<std::uint8_t>(JoinPolicy::FORGET) == 0, "FIXY-FOUND-046: JoinPolicy::FORGET drifted.");
static_assert(static_cast<std::uint8_t>(JoinPolicy::DETACH) == 1, "FIXY-FOUND-046: JoinPolicy::DETACH drifted.");
static_assert(static_cast<std::uint8_t>(JoinPolicy::ABANDON) == 2, "FIXY-FOUND-046: JoinPolicy::ABANDON drifted.");
static_assert(static_cast<std::uint8_t>(JoinPolicy::CANCEL) == 3, "FIXY-FOUND-046: JoinPolicy::CANCEL drifted.");
static_assert(static_cast<std::uint8_t>(JoinPolicy::WAIT_DEADLINE) == 4,
              "FIXY-FOUND-046: JoinPolicy::WAIT_DEADLINE drifted.");
static_assert(static_cast<std::uint8_t>(JoinPolicy::JOIN_ALL) == 5, "FIXY-FOUND-046: JoinPolicy::JOIN_ALL drifted.");
...
static_assert(consistency_count == 5, "FIXY-FOUND-046: Consistency cardinality drifted from 5.");
static_assert(static_cast<std::uint8_t>(Consistency::EVENTUAL) == 0, "FIXY-FOUND-046: Consistency::EVENTUAL drifted.");
...
static_assert(static_cast<std::uint8_t>(Consistency::STRONG) == 4, "FIXY-FOUND-046: Consistency::STRONG drifted.");
...
static_assert(witness_count == 4, "FIXY-FOUND-046: Witness cardinality drifted from 4.");
static_assert(static_cast<std::uint8_t>(Witness::UNWITNESSED) == 0, "FIXY-FOUND-046: Witness::UNWITNESSED drifted.");
static_assert(static_cast<std::uint8_t>(Witness::TYPE_CHECKED) == 1, "FIXY-FOUND-046: Witness::TYPE_CHECKED drifted.");
static_assert(static_cast<std::uint8_t>(Witness::TEST_PASSED) == 2, "FIXY-FOUND-046: Witness::TEST_PASSED drifted.");
...
static_assert(clock_source_count == 10, "FIXY-FOUND-046: ClockSource cardinality drifted from 10.");
static_assert(static_cast<std::uint8_t>(ClockSource::Realtime) == 0, "FIXY-FOUND-046: ClockSource::Realtime drifted.");
...
static_assert(static_cast<std::uint8_t>(ClockSource::Boot) == 3, "FIXY-FOUND-046: ClockSource::Boot drifted.");
...
static_assert(static_cast<std::uint8_t>(ClockSource::TscRaw) == 6, "FIXY-FOUND-046: ClockSource::TscRaw drifted.");
...
static_assert(kFound046PinnedEnumCount == 20, "FIXY-FOUND-046 roster cardinality pin: 20 lattice enums pinned. "
