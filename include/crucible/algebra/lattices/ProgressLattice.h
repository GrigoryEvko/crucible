...
static_assert(progress_class_count == 4, "ProgressClass catalog diverged from {MayDiverge, Terminating, "
...
static_assert(every_progress_class_has_name(), "progress_class_name() switch missing arm for at least one class.");
...
static_assert(every_at_progress_class_has_name(), "ProgressLattice::At<T>::name() switch missing an arm for at "
                                                  "least one class.");
