...
static_assert(stack_use_count == 4, "StackUse diverged from {ConstantFrame, BoundedByParam, "
...
static_assert(every_stack_use_has_name(), "stack_use_name() switch missing an arm for at least one StackUse "
                                          "enumerator.");
