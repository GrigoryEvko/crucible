...
concept CtxFitsSyscallLatencyMint = ::crucible::effects::IsExecCtx<Ctx>
                                 && ::crucible::effects::Subrow<syscall_latency_required_row, typename Ctx::row_type>;
...
static_assert(std::tuple_size_v<mint_syscall_latency_syscall_grants> == 3,
              "mint_syscall_latency_syscall_grants must list exactly 3 syscalls.");
}  // namespace detail::v179_syscall_latency_grant_check
...
static_assert(!CtxFitsSyscallLatencyMint<::crucible::effects::BgCompileCtx>);
...
static_assert(CtxFitsSyscallLatencyMint<::crucible::effects::TestRunnerCtx>);
...
static_assert(!::crucible::effects::Subrow<syscall_latency_required_row,
