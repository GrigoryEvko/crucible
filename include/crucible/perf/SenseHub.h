...
// Loading the program issues bpf() and perf_event_open() and maps the
// counter array.  Those are startup-only operations, so only a context
// carrying the Init capability may reach this surface.
template <class Ctx>
