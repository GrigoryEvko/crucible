...
static_assert(is_send_v<SendP>, "fixy::sess::shape::is_send_v must admit Send<T, K>.  If this "
...
static_assert(v066_surface_cardinality == 6, "fixy::sess::shape:: V-066 surface cardinality drifted — "
