...
static_assert(sizeof(SessionEvent) == 72, "fixy::sess::eventlog::SessionEvent must stay 72 bytes — Cipher "
...
static_assert(u052d_surface_cardinality == 23, "fixy::sess::eventlog:: U-052d surface cardinality drifted — "
