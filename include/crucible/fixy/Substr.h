...
static_assert(substr_total_using == 51, "fixy::substr:: using-decl surface drifted from 51 — Substr.h "
...
static_assert(u051_surface_cardinality == 32, "FIXY-U-051 surface (topology + ctx-fit) drifted from 32 — Substr.h "
