...
//
// FIXY-U-013.  Re-exports the Honda 2008 / Gay-Hole 2005 multi-party
// session type machinery from safety/proto:: (sessions/SessionGlobal.h)
...
static_assert(u013_surface_cardinality == 27,
    ...
    "Mpst.h using-decls AND this sentinel in lockstep.");
...
// surfaces under `-fsyntax-only` of any TU that includes Mpst.h.
//
