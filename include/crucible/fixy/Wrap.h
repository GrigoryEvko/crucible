...
static_assert(::crucible::fixy::wrap::IsSwmrReader<fixy_v_035_swmr_witness::ReaderHandle>,
              "FIXY-V-035: fixy::wrap::IsSwmrReader must accept a handle with "
              "[[nodiscard]] T load() const noexcept.");
static_assert(!::crucible::fixy::wrap::IsSwmrReader<fixy_v_035_swmr_witness::WriterHandle>,
...
static_assert(::crucible::fixy::wrap::is_swmr_reader_v<fixy_v_035_swmr_witness::ReaderHandle>,
...
static_assert(std::is_same_v<::crucible::fixy::wrap::swmr_reader_value_t<fixy_v_035_swmr_witness::ReaderHandle>, int>,
...
static_assert(::crucible::fixy::wrap::SwmrReader<&fixy_v_035_swmr_witness::read_int>,
...
static_assert(!::crucible::fixy::wrap::SwmrReader<&fixy_v_035_swmr_witness::read_from_int>,
...
static_assert(::crucible::fixy::wrap::is_swmr_reader_function_v<&fixy_v_035_swmr_witness::read_int>,
...
static_assert(
    std::is_same_v<::crucible::fixy::wrap::swmr_reader_handle_value_t<&fixy_v_035_swmr_witness::read_int>, int>,
    "FIXY-V-035: swmr_reader_handle_value_t must extract handle payload type.");
static_assert(
    std::is_same_v<::crucible::fixy::wrap::swmr_reader_returned_value_t<&fixy_v_035_swmr_witness::read_int>, int>,
    "FIXY-V-035: swmr_reader_returned_value_t must extract function return type.");
static_assert(::crucible::fixy::wrap::swmr_reader_value_consistent_v<&fixy_v_035_swmr_witness::read_int>,
...
inline void publish_int(fixy_v_035_swmr_witness::WriterHandle&&, int) noexcept {}
...
inline void publish_by_lvalue_ref(fixy_v_035_swmr_witness::WriterHandle&&, int&) noexcept {}
// Negative: return is non-void (writer is "publish and forget").
inline int publish_returns_int(fixy_v_035_swmr_witness::WriterHandle&&, int) noexcept { return 0; }
}  // namespace fixy_v_036_swmr_writer_witness

// IsSwmrWriter<T> — handle-shape concept: positive + negative.
static_assert(::crucible::fixy::wrap::IsSwmrWriter<fixy_v_035_swmr_witness::WriterHandle>,
              "FIXY-V-036: fixy::wrap::IsSwmrWriter must accept a handle with "
              "void publish(T const&) noexcept.");
static_assert(!::crucible::fixy::wrap::IsSwmrWriter<fixy_v_035_swmr_witness::ReaderHandle>,
...
static_assert(::crucible::fixy::wrap::is_swmr_writer_v<fixy_v_035_swmr_witness::WriterHandle>,
...
static_assert(std::is_same_v<::crucible::fixy::wrap::swmr_writer_value_t<fixy_v_035_swmr_witness::WriterHandle>, int>,
...
static_assert(::crucible::fixy::wrap::SwmrWriter<&fixy_v_036_swmr_writer_witness::publish_int>,
              "FIXY-V-036: fixy::wrap::SwmrWriter must accept a function with "
              "(WriterHandle&&, T) → void shape.");
static_assert(!::crucible::fixy::wrap::SwmrWriter<&fixy_v_036_swmr_writer_witness::publish_from_int>,
              "FIXY-V-036: fixy::wrap::SwmrWriter must reject a function whose "
              "param 0 is not a SWMR writer handle.");
static_assert(!::crucible::fixy::wrap::SwmrWriter<&fixy_v_036_swmr_writer_witness::publish_by_lvalue_ref>,
              "FIXY-V-036: fixy::wrap::SwmrWriter must reject a function whose "
              "param 1 is by lvalue reference (writer expects by-value).");
static_assert(!::crucible::fixy::wrap::SwmrWriter<&fixy_v_036_swmr_writer_witness::publish_returns_int>,
              "FIXY-V-036: fixy::wrap::SwmrWriter must reject a function whose "
              "return is non-void (writer is publish-and-forget).");

// is_swmr_writer_function_v<auto FnPtr> — variable-template co-tracks.
static_assert(::crucible::fixy::wrap::is_swmr_writer_function_v<&fixy_v_036_swmr_writer_witness::publish_int>,
...
static_assert(
    std::is_same_v<::crucible::fixy::wrap::swmr_writer_handle_value_t<&fixy_v_036_swmr_writer_witness::publish_int>,
                   int>,
    "FIXY-V-036: swmr_writer_handle_value_t must extract handle payload type.");
static_assert(
    std::is_same_v<::crucible::fixy::wrap::swmr_writer_published_value_t<&fixy_v_036_swmr_writer_witness::publish_int>,
                   int>,
    "FIXY-V-036: swmr_writer_published_value_t must extract param 1 value type.");
static_assert(::crucible::fixy::wrap::swmr_writer_value_consistent_v<&fixy_v_036_swmr_writer_witness::publish_int>,
...
static_assert(std::is_same_v<::crucible::fixy::wrap::signature_traits<&v178_sig_sample>,
...
static_assert(::crucible::fixy::wrap::arity_v<&v178_sig_sample> == 2, "Sentinel: v178_sig_sample has arity 2.");
static_assert(::crucible::fixy::wrap::is_noexcept_v<&v178_sig_sample>, "Sentinel: v178_sig_sample is noexcept.");
static_assert(std::is_same_v<::crucible::fixy::wrap::return_type_t<&v178_sig_sample>, int>,
              "Sentinel: v178_sig_sample returns int.");
static_assert(std::is_same_v<::crucible::fixy::wrap::param_type_t<&v178_sig_sample, 0>, int>,
              "Sentinel: v178_sig_sample param 0 is int.");
static_assert(std::is_same_v<::crucible::fixy::wrap::param_type_t<&v178_sig_sample, 1>, double>,
...
static_assert(!::crucible::fixy::wrap::is_graded_wrapper_v<int>, "Sentinel: int is not a GradedWrapper.");
