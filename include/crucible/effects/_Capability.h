...
static_assert(CapMatchesCtx<Capability<Effect::Bg, Bg>, BgDrainCtx>);
static_assert(CapMatchesCtx<Capability<Effect::Alloc, Bg>, BgDrainCtx>);
static_assert(!CapMatchesCtx<Capability<Effect::IO, Bg>, BgDrainCtx>);
static_assert(CapMatchesCtx<Capability<Effect::IO, Bg>, BgCompileCtx>);
static_assert(!CapMatchesCtx<Capability<Effect::Bg, Bg>, HotFgCtx>);
...
static_assert(CapMatchesCtx<Capability<Effect::Alloc, Init>, BgDrainCtx>);
