...
namespace crucible::mimic::_wip::intel::network {
inline constexpr auto vendor = ::crucible::mimic::_wip::network::NetworkBackendVendor::Intel;
...
static_assert(!::crucible::mimic::_wip::network::network_backend_has_emit_path_v<vendor>,
              "has_emit_path is true for Intel but this header ships no emit "
