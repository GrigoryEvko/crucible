...
struct GpuTargetCaps {
    ...
    safety::Tagged<std::uint32_t, safety::source::Vendor> registers_per_sm_bytes{
        std::uint32_t{0}};  // 256 KB on H100/B200
    safety::Tagged<std::uint32_t, safety::source::Vendor> smem_per_sm_bytes{std::uint32_t{0}};  // 228 KB on Hopper
    safety::Tagged<std::uint32_t, safety::source::Vendor> l1_per_sm_bytes{std::uint32_t{0}};  // 256 KB shared L1+smem
    safety::Tagged<std::uint32_t, safety::source::Vendor> tmem_per_sm_bytes{std::uint32_t{0}};  // 64 KB on Blackwell
...
struct DramChannelTargetCaps {
    ...
    safety::Tagged<std::uint8_t, safety::source::Vendor> channel_width_bits{std::uint8_t{64}};  // 32 / 64 / 128
    safety::Tagged<std::uint16_t, safety::source::Vendor> speed_mts{std::uint16_t{0}};  // mega-transfers/s
