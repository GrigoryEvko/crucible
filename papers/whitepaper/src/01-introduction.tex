...
\textbf{runtime observation} is continuous monitoring (performance prediction, drift detection, bottleneck diagnosis).
...
\S\ref{sec:hardware} & Hardware adaptation (Longitude, runtime observation) \\
