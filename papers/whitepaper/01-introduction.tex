...
\begin{enumerate}
  ...
  \item A prototype implementation (${\sim}9{,}500$ lines of C++26, 24 tests, compiling clean on Clang~22 and GCC~15), accompanied by a Lean~4 formalization (36 modules, 1,312 theorems, zero \code{sorry}).
\end{enumerate}
